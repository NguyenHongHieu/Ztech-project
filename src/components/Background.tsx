    ...
    <div className="w-full bg-[#222] rounded-lg flex flex-wrap items-center justify-center gap-6 py-8 px-2 sm:px-8">
      ...
      <a href="#" className="flex flex-col items-center gap-2 w-28 sm:w-32">
        <span className="block">
          ...
          <Image src="/freetoearn.png" alt="Free to Earn" width={80} height={80} />
        </span>
        <span className="text-xs sm:text-sm text-white font-semibold">FREE TO EARN</span>
      </a>
      {/* Ranking */}
      <a href="#" className="flex flex-col items-center gap-2 w-28 sm:w-32">
        <span className="block">
        ...
        <span className="text-xs sm:text-sm text-white font-semibold">RANKING</span>
      </a>
      {/* Video-NFT */}
      <a href="#" className="flex flex-col items-center gap-2 w-28 sm:w-32">
        <span className="block">
        ...
        <span className="text-xs sm:text-sm text-white font-semibold">VIDEO-NFT</span>
      </a>
      {/* How to Buy */}
      <a href="#" className="flex flex-col items-center gap-2 w-28 sm:w-32">
        <span className="block">
        ...
        <span className="text-xs sm:text-sm text-white font-semibold">HOW TO BUY</span>
      </a>
      {/* New NEFTS */}
      <a href="#" className="flex flex-col items-center gap-2 w-28 sm:w-32 relative">
        <span className="block">
          {/* <svg width="40" height="40" viewBox="0 0 40 40" fill="none">
            <circle cx="20" cy="20" r="18" stroke="#FFD600" strokeWidth="2" />
            <text x="20" y="25" textAnchor="middle" fontSize="10" fill="#FFD600">
        ...
        <span className="text-xs sm:text-sm text-white font-semibold">NEW NEFTS</span>
      </a>
      {/* Roadmap */}
      <a href="#" className="flex flex-col items-center gap-2 w-28 sm:w-32">
        <span className="block">
        ...
        <span className="text-xs sm:text-sm text-white font-semibold">ROADMAPS</span>
      </a>
    </div>
  );
}
