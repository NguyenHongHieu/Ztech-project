  ...
  return (
    <header className="w-full py-2 flex items-center bg-[#181818] text-white px-4 sm:px-8 relative">
        ...
        <div className="fixed inset-0 z-50 bg-[#181818] flex flex-col px-6 py-4">
          <div className="flex items-center justify-between mb-6">
            <div className="flex items-center gap-2">
              <Image src="/logo.svg" alt="Logo" width={56} height={56} className="h-12 w-12" />
            </div>
      ...
      <div className="flex gap-2 sm:gap-4">
        <a href="#" className="bg-yellow-400 text-black px-5 py-2 rounded-full font-bold border border-yellow-400 hover:bg-yellow-500 transition">
          SIGN UP
        </a>
        <a href="#" className="bg-[#181818] text-white px-5 py-2 rounded-full font-bold border border-yellow-400 hover:bg-yellow-500 transition">
          LOG IN
        </a>
      </div>
    </header>
